...
public class ServletService {
    ...
    public static void doService(String method, String query, ServletInfo servletInfo,
        ...
        if (method.equals("GET")) {
            ...
            req = new HttpServletRequestImpl("GET", requestHeader, reqParamsMap, resp, servletInfo.webApp);
            ...
            req = new HttpServletRequestImpl("POST", requestHeader, reqParamsMap, resp, servletInfo.webApp);
        ...
        if (resp.status == HttpServletResponse.SC_OK) {
            ResponseHeaderGeneratorImpl headerGenarator = new ResponseHeaderGeneratorImpl(resp.cookies);

            SendResponse.sendOkResponseHeader(output, resp.contentType, headerGenarator); // レスポンスヘッダをまずクライアントに返す
